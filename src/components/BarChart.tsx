...
const BarChart: React.FC<BarChartProps> = ({ data }) => {
  ...
  return (
    <div className="w-full overflow-x-auto">
      {/* Vertical Bar Chart */}
      <div className="relative" style={{ minHeight: chartHeight + bottomPadding, paddingLeft: '50px', paddingRight: '20px' }}>
        {/* Y-axis labels with proper spacing */}
        <div className="absolute left-0 top-0 flex flex-col justify-between" style={{ width: '45px', height: chartHeight }}>
        ...
        {/* Y-axis line */}
        <div className="absolute left-12 top-0 bottom-0 border-l-2 border-gray-300" style={{ height: chartHeight }} />

        {/* Chart area */}
        <div className="relative ml-14" style={{ height: chartHeight, minWidth: data.length * (barWidth + 24) }}>
          {/* Y-axis grid lines */}
        ...
        <div className="ml-14 mt-4 flex" style={{ gap: '24px', marginTop: '16px' }}>
          {data.map((item, index) => (
            <div
              key={`label-${index}`}
        ...
        {/* X-axis label */}
        <div className="ml-14 mt-16 text-center">
      ...
      <div className="border-t border-gray-200 pt-6 mt-8">
        ...
        <div className="flex items-center justify-between text-sm pt-3 border-t border-gray-100">
          ...
          <span className="font-bold text-gray-900 text-lg">{total.toFixed(0)}</span>
        </div>
      </div>
    </div>
  );
